...
export function AppLayout({ children, isConnected }: AppLayoutProps) {
  const { currentView, setCurrentView, scanProgress, isScanning, logout } = useAppStore();
      ...
      <aside className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold text-white">AI Institutional</h1>
        ...
        <div className="p-4 border-t border-gray-800">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 px-4 rounded-lg text-sm text-gray-400 hover:text-white hover:bg-gray-800 transition-colors"
          >
